...
class Survey_category extends MY_Controller
{
    ...
    private function categoryIndex()
    {
        ...
        if ($records) 
        {
            ...
            $tbl_heading = array(
                '0' => array('data'=> 'ID', 'class' => 'center', 'width' => '100'),
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $htmlAction='';
                $htmlAction .='<form style="padding:0px important; margin: 0 0 0px;" action="'.site_url('administrator/survey_category/modcat').'" method="post">';
    ...
    private function subCategoryIndex()
    {
        ...
        $record_result = $this->survey_category_model->get_paged_subcategories($per_page, $page_offset, $filter);
        $page_info['records'] = $record_result['result'];
        $records = $record_result['result'];
        //echo "<pre>";
        //print_r($records); die();
        ...
        if ($records) 
        {
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $htmlAction .='<input type="hidden" name="interface" value="2" />';
                $htmlAction .='<input type="hidden" name="cat_id" value="'. $records[$i]->id.'" />';
                $htmlAction .='<button type="submit" class="btn btn-info"><i class="icon-edit"></i></button>';
    ...
    private function subTwoCategoryIndex()
    {
        ...
        $record_result = $this->survey_category_model->get_paged_subTwocategories($per_page, $page_offset, $filter);
        $page_info['records'] = $record_result['result'];
        $records = $record_result['result'];
        //echo "<pre>";
        //print_r($records); die();
        ...
        if ($records) 
        {
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $htmlAction .='<input type="hidden" name="interface" value="3" />';
                $htmlAction .='<input type="hidden" name="cat_id" value="'. $records[$i]->id.'" />';
                $htmlAction .='<button type="submit" class="btn btn-info"><i class="icon-edit"></i></button>';
                ...
                $tbl_row = array(
                    '0' => array('data'=> $records[$i]->id, 'class' => 'center', 'width' => '80'),
                    '1' => array('data'=> $records[$i]->cat_parent_name, 'class' => 'center', 'width' => '100'),
    ...
    private function subThreeCategoryIndex()
    {
        ...
        $record_result = $this->survey_category_model->get_pagedThreecategories($per_page, $page_offset, $filter);
        $page_info['records'] = $record_result['result'];
        $records = $record_result['result'];
        //echo "<pre>";
        //print_r($records); die();
        ...
        if ($records) 
        {
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $htmlAction .='<input type="hidden" name="interface" value="4" />';
                $htmlAction .='<input type="hidden" name="cat_id" value="'. $records[$i]->id.'" />';
                $htmlAction .='<button type="submit" class="btn btn-info"><i class="icon-edit"></i></button>';
    ...
    private function subFourCategoryIndex()
    {
        ...
        $record_result = $this->survey_category_model->get_pagedFourcategories($per_page, $page_offset, $filter);
        $page_info['records'] = $record_result['result'];
        $records = $record_result['result'];
        //echo "<pre>";
        //print_r($records); die();
        ...
        if ($records) 
        {
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $htmlAction .='<input type="hidden" name="interface" value="5" />';
                $htmlAction .='<input type="hidden" name="cat_id" value="'. $records[$i]->id.'" />';
                $htmlAction .='<button type="submit" class="btn btn-info"><i class="icon-edit"></i></button>';
    ...
    public function activeTab($tabID='',$pageInfo='')
    {
        ...
        {
            if($this->session->userdata('tab_cat'))
            {
                $param_id=1;
            }
            elseif($this->session->userdata('tab_subcat'))
            {
                $param_id=2;
            }
            elseif($this->session->userdata('tab_subcat_two'))
            {
                $param_id=3;
            }
            elseif($this->session->userdata('tab_subcat_three'))
            {
                $param_id=4;
            }
            elseif($this->session->userdata('tab_subcat_four'))
            {
                $param_id=5;
            }
        }
    ...
    public function modcat()
    {
        ...
        return redirect(site_url('administrator/survey_category/edit/'. $cat_id));
    ...
    public function add()
    {
        ...
        $getAllCategoryInfo=$this->Select_global_model->FlyQuery(array(),'exm_survey_categories','select','*');
    ...
    public function add_category()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $ex=$this->Select_global_model->FlyQuery(array('cat_name'=>$this->input->post('cat_name')),'exm_survey_categories','count');
    ...
    //print_r('dd'); die();
                if ($res > 0) {
                    ...
                    redirect('administrator/survey_category/add');
                } else {
    ...
    public function add_sub_category()
    {
        ...
        $getAllCategoryInfo=$this->Select_global_model->FlyQuery(array(),'exm_survey_sub_categories','select','*');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $ex=$this->Select_global_model->FlyQuery(array('cat_name'=>$cat_name,'cat_parent'=>$cat_parent),'exm_survey_sub_categories','count');
            ...
            if($ex==0)
           {
                ...
                $res = (int)$this->survey_category_model->add_sub_category($data);
    //print_r('dd'); die();
                if ($res > 0) {
    ...
    public function add_sub_two_category()
    {
        ...
        $getAllCategoryInfo=$this->Select_global_model->FlyQuery(array(),'exm_survey_sub_two_categories','select','*');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $ex=$this->Select_global_model->FlyQuery(array('cat_name'=>$cat_name,'cat_parent'=>$cat_parent,'sub_cat_parent'=>$sub_cat_parent),'exm_survey_sub_two_categories','count');
            ...
            if($ex==0)
           {
                ...
                $res = (int)$this->survey_category_model->add_sub_two_category($data);
    //print_r('dd'); die();
                if ($res > 0) {
    ...
    public function add_sub_three_category()
    {
        ...
        $getAllCategoryInfo=$this->Select_global_model->FlyQuery(array(),'exm_survey_sub_three_categories','select','*');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $ex=$this->Select_global_model->FlyQuery(array('cat_name'=>$cat_name,'cat_parent'=>$cat_parent,'sub_cat_parent'=>$sub_cat_parent,'sub_two_cat_parent'=>$sub_two_cat_parent),'exm_survey_sub_three_categories','count');
            ...
            if($ex==0)
           {
                ...
                $res = (int)$this->survey_category_model->add_sub_three_category($data);
    //print_r('dd'); die();
                if ($res > 0) {
    ...
    public function add_sub_four_category()
    {
        ...
        $getAllCategoryInfo=$this->Select_global_model->FlyQuery(array(),'exm_survey_sub_four_categories','select','*');
       ...
       $this->activeTab(5,$page_info);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $ex=$this->Select_global_model->FlyQuery(array('cat_name'=>$cat_name,'cat_parent'=>$cat_parent,'sub_cat_parent'=>$sub_cat_parent,'sub_two_cat_parent'=>$sub_two_cat_parent,'sub_three_cat_parent'=>$sub_three_cat_parent),'exm_survey_sub_four_categories','count');
            ...
            if($ex==0)
           {
                ...
                $res = (int)$this->survey_category_model->add_sub_four_category($data);
    //print_r('dd'); die();
                if ($res > 0) {
    ...
    public function edit()
    {
        ...
        if(!empty($this->session->userdata('tab_cat')))
        {
           $activityName="Edit Survey Category ";
        ...
        elseif(!empty($this->session->userdata('tab_subcat')))
        {
           $activityName="Edit Survey Sub Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->survey_category_model->get_subcategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
        ...
        elseif(!empty($this->session->userdata('tab_subcat_two')))
        {
           $activityName="Edit Survey Sub 2 Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->survey_category_model->get_subtwocategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
           $this->form_data->cat_parent = $category->cat_parent;
           $this->form_data->sub_cat_parent = $category->sub_cat_parent;
           $this->form_data->cat_name = $category->cat_name;
        }
        elseif(!empty($this->session->userdata('tab_subcat_three')))
        {
           $activityName="Edit Survey Sub 3 Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->survey_category_model->get_subthreecategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
           $this->form_data->cat_parent = $category->cat_parent;
           $this->form_data->sub_cat_parent = $category->sub_cat_parent;
           $this->form_data->sub_two_cat_parent = $category->sub_two_cat_parent;
           $this->form_data->cat_name = $category->cat_name;
        }
        elseif(!empty($this->session->userdata('tab_subcat_four')))
        {
           $activityName="Edit Survey Sub 4 Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->survey_category_model->get_subfourcategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
           $this->form_data->cat_parent = $category->cat_parent;
           $this->form_data->sub_cat_parent = $category->sub_cat_parent;
           $this->form_data->sub_two_cat_parent = $category->sub_two_cat_parent;
           $this->form_data->sub_three_cat_parent = $category->sub_three_cat_parent;
           $this->form_data->cat_name = $category->cat_name;
        }
        else
        {
    ...
    public function update_category()
    {
        ...
        elseif(!empty($this->session->userdata('tab_subcat')))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->form_data->cat_id = $cat_id;
                $this->form_data->cat_parent = $cat_parent;
                $this->load->view('administrator/layouts/default', $page_info);
                ...
                if ($this->survey_category_model->update_subCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
        ...
        elseif(!empty($this->session->userdata('tab_subcat_two')))
        {
            $cat_id = (int)$this->input->post('cat_id');
            $cat_parent = (int)$this->input->post('cat_parent');
            $sub_cat_parent = (int)$this->input->post('sub_cat_parent');
            $cat_name = $this->input->post('cat_name');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->form_data->cat_id = $cat_id;
                $this->form_data->cat_parent = $cat_parent;
                $this->form_data->sub_cat_parent = $sub_cat_parent;
                $this->load->view('administrator/layouts/default', $page_info);
                ...
                if ($this->survey_category_model->update_subTwoCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
        ...
        elseif(!empty($this->session->userdata('tab_subcat_three')))
        {
            ...
            $cat_parent = (int)$this->input->post('cat_parent');
            $sub_cat_parent = (int)$this->input->post('sub_cat_parent');
            $sub_two_cat_parent = (int)$this->input->post('sub_two_cat_parent');
            $cat_name = $this->input->post('cat_name');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->form_data->cat_parent = $cat_parent;
                $this->form_data->sub_cat_parent = $sub_cat_parent;
                $this->form_data->sub_two_cat_parent = $sub_two_cat_parent;
                $this->load->view('administrator/layouts/default', $page_info);
                ...
                if ($this->survey_category_model->update_subThreeCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
        ...
        elseif(!empty($this->session->userdata('tab_subcat_four')))
        {
            ...
            $sub_cat_parent = (int)$this->input->post('sub_cat_parent');
            $sub_two_cat_parent = (int)$this->input->post('sub_two_cat_parent');
            $sub_three_cat_parent = (int)$this->input->post('sub_three_cat_parent');
            $cat_name = $this->input->post('cat_name');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->form_data->sub_cat_parent = $sub_cat_parent;
                $this->form_data->sub_two_cat_parent = $sub_two_cat_parent;
                $this->form_data->sub_three_cat_parent = $sub_three_cat_parent;
                $this->load->view('administrator/layouts/default', $page_info);
                ...
                if ($this->survey_category_model->update_subFourCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
