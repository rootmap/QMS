...
class Question extends MY_Controller
{
    ...
    public function index()
    {
       ...
       /* $this->session->unset_userdata('filter_category');
            $this->session->unset_userdata('filter_sub_cat_parent');
            $this->session->unset_userdata('filter_sub_two_cat_parent');
            $this->session->unset_userdata('filter_sub_three_cat_parent');
            $this->session->unset_userdata('filter_sub_four_cat_parent');*/
        ...
        if ($this->session->flashdata('filter_sub_cat_parent')) {
            $this->session->keep_flashdata('filter_sub_cat_parent');
            $filter_sub_cat_parent = (int)$this->session->flashdata('filter_sub_cat_parent');
            $this->form_data->filter_sub_cat_parent = $filter_sub_cat_parent;
            $filter['filter_category']['field'] = 'sub_category_id';
            $filter['filter_category']['value'] = $filter_sub_cat_parent;
        }
        if ($this->session->flashdata('filter_sub_two_cat_parent')) {
            $this->session->keep_flashdata('filter_sub_two_cat_parent');
            $filter_sub_two_cat_parent = (int)$this->session->flashdata('filter_sub_two_cat_parent');
            $this->form_data->filter_sub_two_cat_parent = $filter_sub_two_cat_parent;
            $filter['filter_category']['field'] = 'sub_two_category_id';
            $filter['filter_category']['value'] = $filter_sub_two_cat_parent;
        }
        if ($this->session->flashdata('filter_sub_three_cat_parent')) {
            $this->session->keep_flashdata('filter_sub_three_cat_parent');
            $filter_sub_three_cat_parent = (int)$this->session->flashdata('filter_sub_three_cat_parent');
            $this->form_data->filter_sub_three_cat_parent = $filter_sub_three_cat_parent;
            $filter['filter_category']['field'] = 'sub_three_category_id';
            $filter['filter_category']['value'] = $filter_sub_three_cat_parent;
        }
        if ($this->session->flashdata('filter_sub_four_cat_parent')) {
            $this->session->keep_flashdata('filter_sub_four_cat_parent');
            $filter_sub_four_cat_parent = (int)$this->session->flashdata('filter_sub_four_cat_parent');
            $this->form_data->filter_sub_four_cat_parent = $filter_sub_four_cat_parent;
            $filter['filter_category']['field'] = 'sub_four_category_id';
            $filter['filter_category']['value'] = $filter_sub_four_cat_parent;
        }
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '3' => array('data'=> 'Sub Category'),
                '4' => array('data'=> 'Sub 2 Category'),
                '5' => array('data'=> 'Sub 3 Category'),
                '6' => array('data'=> 'Sub 4 Category'),
                '7' => array('data'=> 'Details', 'class' => 'center', 'width' => '140'),
                '8' => array('data'=> 'Uses Stat', 'class' => 'center', 'width' => '140'),
                '9' => array('data'=> 'Type', 'class' => 'center', 'width' => '120'),
                '10' => array('data'=> 'Is Expired?', 'class' => 'center', 'width' => '80'),
                '11' => array('data'=> 'Status', 'class' => 'center', 'width' => '200'),
                '12' => array(
                             'data'=> 'Bulk Status Change 
                                                    <br /> 
                                       <input type="checkbox" id="aprall" name="aprall" class="aprall">', 
                             'class' => 'center', 'width' => '120'),                
                '13' => array('data'=> 'Created By', 'class' => 'center', 'width' => '80'),
                '14' => array('data'=> 'Action', 'class' => 'center', 'width' => '50')
            );
            ...
            for ($i = 0; $i<count($records); $i++) 
            {
                ...
                if ($records[$i]->ques_type == 'mcq') {
                   ...
                   /*if($records[$i]->id=="455")
                    {
                        echo $total_used_question_in_category_count; die();
                    }*/
                ...
                if(!isSystemAuditor())
                {
                    ...
                    $status = '<a href="'. base_url('changeQuestionstatus/2:'. $records[$i]->id) .'"><span class="label label-success">Approve</span></a>&nbsp;&nbsp;<a href="'. base_url('changeQuestionstatus/3:'. $records[$i]->id) .'"><span class="label label-important">Reject</span></a>';
                    }
                ...
                if ($records[$i]->category_id > 0) {
                    $category_str = $this->getCatNameByObject($records[$i]->category_id,"exm_categories");
                }

                $subcategory_str = '';
                if ($records[$i]->sub_category_id > 0) {
                    $subcategory_str = $this->getCatNameByObject($records[$i]->sub_category_id,"exm_sub_categories");
                }

                $sub_two_category_id = '';
                if ($records[$i]->sub_two_category_id > 0) {
                    $sub_two_category_id = $this->getCatNameByObject($records[$i]->sub_two_category_id,"exm_sub_two_categories");
                }

                $sub_three_category_id = '';
                if ($records[$i]->sub_three_category_id > 0) {
                    $sub_three_category_id = $this->getCatNameByObject($records[$i]->sub_three_category_id,"exm_sub_three_categories");
                }

                $sub_four_category_id = '';
                if ($records[$i]->sub_four_category_id > 0) {
                    $sub_four_category_id = $this->getCatNameByObject($records[$i]->sub_four_category_id,"exm_sub_four_categories");
                }
                ...
                $tbl_row = array(
                    ...
                    '3' => array('data'=> $subcategory_str),
                    '4' => array('data'=> $sub_two_category_id),
                    '5' => array('data'=> $sub_three_category_id),
                    '6' => array('data'=> $sub_four_category_id),
                    '7' => array('data'=> $stat_str, 'class' => 'center', 'width' => '130'),
                    '8' => array('data'=> $uses_stat_str, 'class' => 'center', 'width' => '120'),
                    '9' => array('data'=> $question_type, 'class' => 'center', 'width' => '120'),
                    '10' => array('data'=> $expired_str, 'class' => 'center', 'width' => '130'),
                    '11' => array('data'=> $status, 'class' => 'center', 'width' => '50'),
                    '12' => array('data'=> $selectact, 'class' => 'center', 'width' => '50'),                    
                    '13' => array('data'=>$records[$i]->created_by_name, 'class' => 'center', 'width' => '50'),
                    '14' => array('data'=> $action_str, 'class' => 'center', 'width' => '50')
                );
    ...
    public function export_editbulk_data()
    {
        

        $record_result = $this->question_model->get_all_questions();
        ...
        /*//print_r_pre($records[6]);

         $ques_choices_un=unserialize($records[6]->ques_choices);
        print_r_pre($ques_choices_un);
        
        //echo count($ques_choices_un); die();
        if(!empty($ques_choices_un))
        {
            if(count($ques_choices_un)>0)
            {
                $k=1;
                foreach($ques_choices_un as $choi)
                {
                    $choices .=$choi['text'];
                    if($choi['is_answer']==1)
                    { 
                        if(!empty($choices_answer))
                        {
                            $choices_answer .=",";
                        }
                        $choices_answer .=$k;
...
*/
       //echo $choices;
        ...
        //$update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            ...
            if (is_array($records) && count($records) > 0) {
                ...
                $this->excel->getActiveSheet()->setCellValue('A1', 'SYSID.');
                $this->excel->getActiveSheet()->setCellValue('B1', 'Category ID');
                $this->excel->getActiveSheet()->setCellValue('C1', 'Category Name');

                $this->excel->getActiveSheet()->setCellValue('D1', 'Sub Category ID');
                $this->excel->getActiveSheet()->setCellValue('E1', 'Sub Category Name');
                $this->excel->getActiveSheet()->setCellValue('F1', 'Sub 2 Category ID');
                $this->excel->getActiveSheet()->setCellValue('G1', 'Sub 2 Category Name');
                $this->excel->getActiveSheet()->setCellValue('H1', 'Sub 3 Category ID');
                $this->excel->getActiveSheet()->setCellValue('I1', 'Sub 3 Category Name');
                $this->excel->getActiveSheet()->setCellValue('J1', 'Sub 4 Category ID');
                $this->excel->getActiveSheet()->setCellValue('K1', 'Sub 4 Category Name');

                $this->excel->getActiveSheet()->setCellValue('L1', 'Questions');
                $this->excel->getActiveSheet()->setCellValue('M1', 'Question Type');
                $this->excel->getActiveSheet()->setCellValue('N1', 'Marks');
                $this->excel->getActiveSheet()->setCellValue('O1', 'Negative Marks');
                $this->excel->getActiveSheet()->setCellValue('P1', 'Is Mandatory');
                $this->excel->getActiveSheet()->setCellValue('Q1', 'Question Choices');
                $this->excel->getActiveSheet()->setCellValue('R1', 'Right Choices');
                $this->excel->getActiveSheet()->setCellValue('S1', 'Expiry Date');

                //$this->excel->getActiveSheet()->getStyle('Q1:Q'.$this->excel->getActiveSheet()->getHighestRow())
    //->getAlignment()->setWrapText(true); 
                ...
                if($records){
                    for ($i=0; $i<count($records); $i++) {
                        ...
                        $ques_choices=$records[$i]->ques_choices;

                        if(!empty($ques_choices) && $records[$i]->ques_type=="mcq")
                        {
                            $ques_choices_un=unserialize($ques_choices);
                            //print_r_pre($ques_choices_un);
                            ...
                            if(!empty($ques_choices_un))
                            {
                                ...
                                {
                                    $k=1;
                                    foreach($ques_choices_un as $inx=>$choi)
                                    {
                                        if($inx==0)
                                        {
                                            $choices .=trim($choi['text']);
                                        }
                                        else
                                        {
                                            $choices .="\n".trim($choi['text']);
                        ...
                        $expire_date=date('F d, Y',strtotime($records[$i]->ques_expiry_date));

                        //echo $expire_date; die();
                        
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(0, $row, $records[$i]->id);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(1, $row, $records[$i]->category_id);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(2, $row, $records[$i]->category_name);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $records[$i]->sub_category_id);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $records[$i]->sub_category_name);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $records[$i]->sub_two_category_id);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(6, $row, $records[$i]->sub_two_category_name);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(7, $row, $records[$i]->sub_three_category_id);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(8, $row, $records[$i]->sub_three_category_name);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(9, $row, $records[$i]->sub_four_category_id);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(10, $row, $records[$i]->sub_four_category_name);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(11, $row, strip_tags(htmlspecialchars_decode($records[$i]->ques_text)));
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(12, $row, $records[$i]->ques_type);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(13, $row, $records[$i]->mark);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(14, $row, $records[$i]->neg_mark);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(15, $row, $records[$i]->is_mandatory);

                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(16, $row, $choices);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(17, $row, $choices_answer);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(18, $row, $expire_date);
       
                    }
                }
                
                
                $filename = 'Edit Bulk Question Data '. date('Y-m-d') .'.xlsx';
    ...
    private function getCatNameByObject($catID,$identifier)
    {
        if($catID>0 && !empty($identifier))
        {
             $objectCatName="";
             $object=$this->Select_global_model->FlyQuery(array("SELECT * FROM ".$identifier." WHERE id=".$catID));
             if(count($object))
             {
                $objectCatName=$object[0]["cat_name"];
             }

             return $objectCatName;
    ...
    {
        //print_r_pre($this->input->post());

        $filter_category = (int)$this->input->post('category_id');
        $filter_sub_cat_parent = (int)$this->input->post('sub_cat_parent');
        $filter_sub_two_cat_parent = (int)$this->input->post('sub_two_cat_parent');
        $filter_sub_three_cat_parent = (int)$this->input->post('sub_three_cat_parent');
        $filter_sub_four_cat_parent = (int)$this->input->post('sub_four_cat_parent');
        ...
        if ($filter_clear == '') {
            ...
            if ($filter_sub_cat_parent > 0) {
                $this->session->set_flashdata('filter_sub_cat_parent', $filter_sub_cat_parent);
            }
            if ($filter_sub_two_cat_parent > 0) {
                $this->session->set_flashdata('filter_sub_two_cat_parent', $filter_sub_two_cat_parent);
            }
            if ($filter_sub_three_cat_parent > 0) {
                $this->session->set_flashdata('filter_sub_three_cat_parent', $filter_sub_three_cat_parent);
            }
            if ($filter_sub_four_cat_parent > 0) {
                $this->session->set_flashdata('filter_sub_four_cat_parent', $filter_sub_four_cat_parent);
            }
    ...
    { //question updaed
       ...
       // print_r_pre($t->id);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $sub_category_id = (int)$this->input->post('sub_cat_parent');
            $sub_two_category_id = (int)$this->input->post('sub_two_cat_parent');
            $sub_three_category_id = (int)$this->input->post('sub_three_cat_parent');
            $sub_four_category_id = (int)$this->input->post('sub_four_cat_parent');
            ...
            if($ex==0)
            {
                ...
                $data = array(
                    ...
                    'sub_two_category_id' => $sub_two_category_id,
                    'sub_three_category_id' => $sub_three_category_id,
                    'sub_four_category_id' => $sub_four_category_id,
                    'ques_text' => $ques_text,
                    'ques_type' => $ques_type,
        ...
        if ($_FILES['question_file']['tmp_name'] != '' && $_FILES['question_file']['error'] == 0) {
            ...
            if ($file_error == '') {
                ...
                for ($i=$start; $i<=count($sheetData); $i++) {
                    ...
                    $sub_category_id = trim($sheetData[$i]['C']);
                    $sub_two_category_id = trim($sheetData[$i]['E']);
                    $sub_three_category_id = trim($sheetData[$i]['G']);
                    $sub_four_category_id = trim($sheetData[$i]['I']);
                    $question_text = trim($sheetData[$i]['K']);
                    $question_type = trim($sheetData[$i]['L']);
                    $question_mark = trim($sheetData[$i]['M']);
                    $question_neg_mark = trim($sheetData[$i]['N']);
                    $is_mandatory = trim($sheetData[$i]['O']);
                    $question_choices = $sheetData[$i]['P'];
                    $right_choices = trim($sheetData[$i]['Q']);
                    $question_expiry_date = trim($sheetData[$i]['R']);
                    ...
                    if ($question_category == '' && $question_text == '' && $question_type == '' && $question_choices == '' && $right_choices == '' && $question_expiry_date == '') {
                        ...
                        $questions[$i]['sub_category_id'] = $sub_category_id;
                        $questions[$i]['sub_two_category_id'] = $sub_two_category_id;
                        $questions[$i]['sub_three_category_id'] = $sub_three_category_id;
                        $questions[$i]['sub_four_category_id'] = $sub_four_category_id;
                ...
                if (count($questions) > 0) {
                    foreach($questions as $row => $question) {
                        ...
                        $sub_two_category_id=$question['sub_two_category_id'];
                        $sub_three_category_id=$question['sub_three_category_id'];
                        $sub_four_category_id=$question['sub_four_category_id'];
                        ...
                        if ($row_has_error) {
                            ...
                            $questions[$row]['sub_category_id'] = $sub_category_id;
                            $questions[$row]['sub_two_category_id'] = $sub_two_category_id;
                            $questions[$row]['sub_three_category_id'] = $sub_three_category_id;
                            $questions[$row]['sub_four_category_id'] = $sub_four_category_id;

                            $questions[$row]['ques_text'] = json_encode($question_text);
               ...
               // $_SESSION['bulk_questions']=$questions;
               // $_SESSION['bulk_invalid_questions']=$invalid_questions;
               // $_SESSION['bulk_error_messages']=$error_messages;
    ...
    public function edit()
    {
        ...
        $this->form_data->sub_category_id = $question->sub_category_id;
        $this->form_data->sub_two_category_id = $question->sub_two_category_id;
        $this->form_data->sub_three_category_id = $question->sub_three_category_id;
        $this->form_data->sub_four_category_id = $question->sub_four_category_id;
    ...
    public function update_question()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->form_data->sub_category_id = $sub_category_id;
            $this->form_data->sub_two_category_id = $sub_two_category_id;
            $this->form_data->sub_three_category_id = $sub_three_category_id;
            $this->form_data->sub_four_category_id = $sub_four_category_id;
            $this->load->view('administrator/layouts/default', $page_info);
    ...
    public function edit_bulk_upload()
    {
        ...
        if ($_FILES['question_file']['tmp_name'] != '' && $_FILES['question_file']['error'] == 0) {
            ...
            if ($file_error == '') {
                ...
                for ($i=$start; $i<=count($sheetData); $i++) {
                    $question_id = trim($sheetData[$i]['A']);

                    $question_category = trim($sheetData[$i]['B']);
                    $question_sub_category_id = trim($sheetData[$i]['D']);
                    $question_sub_two_category_id = trim($sheetData[$i]['F']);
                    $question_sub_three_category_id = trim($sheetData[$i]['H']);
                    $question_sub_four_category_id = trim($sheetData[$i]['J']);

                    $question_text = trim($sheetData[$i]['L']);
                    $question_type = trim($sheetData[$i]['M']);
                    $question_mark = trim($sheetData[$i]['N']);
                    $question_neg_mark = trim($sheetData[$i]['O']);
                    $is_mandatory = trim($sheetData[$i]['P']);
                    $question_choices = $sheetData[$i]['Q'];
                    $right_choices = trim($sheetData[$i]['R']);
                    $question_expiry_date = trim($sheetData[$i]['S']);
                    ...
                    if ($question_category == '' && $question_text == '' && $question_type == '' && $question_choices == '' && $right_choices == '' && $question_expiry_date == '') {
                        ...
                        $questions[$i]['category_id'] = $question_category;
                        $questions[$i]['sub_category_id'] = $question_sub_category_id;
                        $questions[$i]['sub_two_category_id'] = $question_sub_two_category_id;
                        $questions[$i]['sub_three_category_id'] = $question_sub_three_category_id;
                        $questions[$i]['sub_four_category_id'] = $question_sub_four_category_id;
                ...
                if (count($questions) > 0) {
                    foreach($questions as $row => $question) {
                        ...
                        $question_category=$question['category_id'];
                        $question_sub_category_id=$question['sub_category_id'];
                        $question_sub_two_category_id=$question['sub_two_category_id'];
                        $question_sub_three_category_id=$question['sub_three_category_id'];
                        $question_sub_four_category_id=$question['sub_four_category_id'];
                        ...
                        if ($row_has_error) {
                            ...
                            $questions[$row]['question_id'] = $question_id;

                            $questions[$row]['category_id']=$question_category;
                            $questions[$row]['sub_category_id']=$question_sub_category_id;
                            $questions[$row]['sub_two_category_id']=$question_sub_two_category_id;
                            $questions[$row]['sub_three_category_id']=$question_sub_three_category_id;
                            $questions[$row]['sub_four_category_id']=$question_sub_four_category_id;
    ...
    private function _set_fields()
    {
        ...
        $this->form_data->filter_sub_cat_parent = 0;
        $this->form_data->filter_sub_two_cat_parent = 0;
        $this->form_data->filter_sub_three_cat_parent = 0;
        $this->form_data->filter_sub_four_cat_parent = 0;
    ...
    public function questionPending()
    {
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '5' => array('data'=> 'Sub 3 Category'),
                '6' => array('data'=> 'Sub 4 Category'),
                '7' => array('data'=> 'Details', 'class' => 'center', 'width' => '130'),
                '8' => array('data'=> 'Uses Stat', 'class' => 'center', 'width' => '120'),
                '9' => array('data'=> 'Type', 'class' => 'center', 'width' => '120'),
                '10' => array('data'=> 'Is Expired?', 'class' => 'center', 'width' => '80'),
                '11' => array('data'=> 'Status', 'class' => 'center', 'width' => '120'),
                '12' => array('data'=> 'Bulk Status Change 
                                                    <br /> 
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $tbl_row = array(
                    ...
                    '8' => array('data'=> $uses_stat_str, 'class' => 'center', 'width' => '120'),
                    '9' => array('data'=> $question_type, 'class' => 'center', 'width' => '120'),
                    '10' => array('data'=> $expired_str, 'class' => 'center', 'width' => '80'),
                    '11' => array('data'=> $status, 'class' => 'center', 'width' => '50'),
                    '12' => array('data'=> $selectact, 'class' => 'center', 'width' => '50'),
                    '13' => array('data'=>$records[$i]->created_by_name, 'class' => 'center', 'width' => '50'),
                    '14' => array('data'=> $action_str, 'class' => 'center', 'width' => '50')
    ...
    public function questionApproved()
    {
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '9' => array('data'=> 'Type', 'class' => 'center', 'width' => '120'),
                '10' => array('data'=> 'Is Expired?', 'class' => 'center', 'width' => '80'),
                '11' => array('data'=> 'Status', 'class' => 'center', 'width' => '80'),
                '12' => array('data'=> 'Bulk Status Change 
                                                    <br /> 
    ...
    public function questionRejected()
    {
        ...
        if ($records) {
            ...
            $tbl_heading = array(
                ...
                '10' => array('data'=> 'Is Expired?', 'class' => 'center', 'width' => '80'),
                '11' => array('data'=> 'Status', 'class' => 'center', 'width' => '80'),
                '12' => array('data'=> 'Created By', 'class' => 'center', 'width' => '80'),
                '13' => array('data'=> 'Action', 'class' => 'center', 'width' => '50')
            );
            $this->table->set_heading($tbl_heading);
            ...
            for ($i = 0; $i<count($records); $i++) {
                ...
                $tbl_row = array(
                    ...
                    '10' => array('data'=> $expired_str, 'class' => 'center', 'width' => '80'),
                    '11' => array('data'=> $status, 'class' => 'center', 'width' => '50'),
                    '12' => array('data'=>$records[$i]->created_by_name, 'class' => 'center', 'width' => '50'),
                    '13' => array('data'=> $action_str, 'class' => 'center', 'width' => '50')
                );
                $this->table->add_row($tbl_row);
            }
