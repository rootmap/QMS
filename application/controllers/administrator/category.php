...
class Category extends MY_Controller
{
    ...
    public function edit()
    {
        ...
        elseif(!empty($this->session->userdata('tab_subcat')))
        {
           $activityName="Edit Sub Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->category_model->get_subcategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
        ...
        elseif(!empty($this->session->userdata('tab_subcat_two')))
        {
           $activityName="Edit Sub 2 Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->category_model->get_subtwocategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
           $this->form_data->cat_parent = $category->cat_parent;
        ...
        elseif(!empty($this->session->userdata('tab_subcat_three')))
        {
           $activityName="Edit Sub 3 Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->category_model->get_subthreecategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
           $this->form_data->cat_parent = $category->cat_parent;
           $this->form_data->sub_cat_parent = $category->sub_cat_parent;
        ...
        elseif(!empty($this->session->userdata('tab_subcat_four')))
        {
           $activityName="Edit Sub 4 Category ";
           $cat_id = (int)$this->uri->segment(4);
           $category = $this->category_model->get_subfourcategory($cat_id);
           //print_r_pre($category);
           $this->form_data->cat_id = $category->id;
           $this->form_data->cat_parent = $category->cat_parent;
           $this->form_data->sub_cat_parent = $category->sub_cat_parent;
    ...
    public function update_category()
    {
        ...
        elseif(!empty($this->session->userdata('tab_subcat')))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->category_model->update_subCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
        ...
        elseif(!empty($this->session->userdata('tab_subcat_two')))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->category_model->update_subTwoCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
        ...
        elseif(!empty($this->session->userdata('tab_subcat_three')))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->category_model->update_subThreeCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
        ...
        elseif(!empty($this->session->userdata('tab_subcat_four')))
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->category_model->update_subFourCategory($cat_id, $data)) {
                    $this->session->set_flashdata('message_success', 'Update is successful.');
                } else  {
                    $this->session->set_flashdata('message_error', $this->category_model->error_message. ' Update is unsuccessful.');
                }
