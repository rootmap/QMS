        ...
        if ($exam_id > 0) {
            ...
            if ($records) {
                ...
                for ($i = 0; $i<count($records); $i++) {
                    ...
                    $start_time = date('d/m/Y, g:i A', strtotime($records[$i]->ue_start_date." ".$records[$i]->ue_start_time));
                    $end_time = date('d/m/Y, g:i A', strtotime($records[$i]->ue_end_date." ".$records[$i]->ue_end_time));
