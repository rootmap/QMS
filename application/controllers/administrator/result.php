...
class Result extends MY_Controller
{
    ...
    public function downloadformat()
    {
        ...
        $getAllUserAssignThisExam=$this->select_global_model->FlyQuery(array('SELECT dbo.get_user_login_name_by_id(exm_user_exams.user_id)  as user_id,
                                                                            exm_results.result_status,
                                                                            exm_results.result_total_questions,
                                                                            exm_results.result_total_answered,
                                                                            exm_results.result_total_correct,
                                                                            exm_results.result_total_wrong,
                                                                            exm_results.result_exam_score,
                                                                            exm_results.result_user_score,
                                                                            exm_results.result_competency_level,
                                                                            exm_results.result_time_spent,
                                                                            exm_results.result_start_time,
                                                                            exm_results.result_end_time
                                                                            FROM exm_user_exams 
                                                                            LEFT JOIN exm_results ON exm_results.user_exam_id=exm_user_exams.id
                                                                            WHERE exm_user_exams.exam_id='.$examID.' AND exm_user_exams.set_id='.$setID));
       ...
       // echo $this->toAlpha(12); die();
        ...
        //$update_data = $this->insert_global_model->globalinsert($this->tbl_exam_users_activity,array('user_id'=>$this->logged_in_user->id,
            //'activity_time'=>date('Y-m-d H:i:s'),'activity'=>'Export Survey Detail Report'));
                ...
                if(count($getAllUserAssignThisExam)>0)
                {
                    $kindex=2;
                    foreach($getAllUserAssignThisExam as $exm)
                    {
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(0, $kindex, $exm['user_id']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(1, $kindex, $exm['result_status']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(2, $kindex, $exm['result_total_questions']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(3, $kindex, $exm['result_total_answered']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(4, $kindex, $exm['result_total_correct']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(5, $kindex, $exm['result_total_wrong']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(6, $kindex, $exm['result_exam_score']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(7, $kindex, $exm['result_user_score']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(8, $kindex, $exm['result_competency_level']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(9, $kindex, $exm['result_time_spent']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(10, $kindex, $exm['result_start_time']);
                        $this->excel->getActiveSheet()->setCellValueByColumnAndRow(11, $kindex, $exm['result_end_time']);
                ...
                $filename = 'Sample Format Exam Result '. date('Y-m-d') .'.xlsx';
