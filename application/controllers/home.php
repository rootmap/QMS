...
class Home extends MY_Controller
{
    ...
    public function index()
	{
        ...
        if ($all_open_exams) {
            for ($i=0; $i<count($all_open_exams); $i++) {
                ...
                //print_r_pre($all_open_exams[$i]->exam->exam_random_qus);
    ...
    public function download_admitcard()
    {
        ...
        //echo "SELECT * FROM exm_user_exams WHERE id='".$question_set_id."'"; die();

        $sqlUserExamSetInfo=$this->Select_global_model->FlyQuery(array("SELECT * FROM exm_user_exams WHERE id='".$question_set_id."'"));

        $pureSetID=$sqlUserExamSetInfo[0]['set_id'];
        $sqlSetInfo=$this->Select_global_model->FlyQuery(array("SELECT *,dbo.get_user_login_name_by_id(created_by) as creator_name,dbo.get_user_login_name_by_id(updated_by) as approver_name FROM exm_question_set WHERE id='".$pureSetID."'"));

        //$createdByQuestionSet=
        $approver_name=$sqlSetInfo[0]['approver_name'];
        if(empty($sqlSetInfo[0]['approver_name']))
        {
            $approver_name=$sqlSetInfo[0]['creator_name'];
        }

        $questionSetCreateDate=date('d/m/Y',strtotime($sqlSetInfo[0]['created_at']));

        //print_r_pre($sqlSetInfo);
       ...
       //echo $this->user_model->get_user_profile_path(); die();
        ...
        //echo base_url().'uploads/signature/'.$this->user_model->get_user_signature_path();
        ...
        //echo $filePathUserSignature; die();
       ...
       // print_r_pre($exam_details);
        ...
        $dataQrcCodeString .=", Exam Name: ".$exam_details->exam_title;
        $dataQrcCodeString .=", Role ID: XXXXX";
        $dataQrcCodeString .=", Role Name: XXXXX";
        $dataQrcCodeString .=", Exam Date: ".$dateofExam;
        $dataQrcCodeString .=", Location: ".$venuesLocation;
        $dataQrcCodeString .=", Questionnaire Set No: ".$sqlSetInfo[0]['name'];
        $dataQrcCodeString .=", Questionnaire Preparation Date: ".$questionSetCreateDate;
        $dataQrcCodeString .=", Questionnaire Approver ID: ".$approver_name;
...
<div style=" text-align:center; border:1px #000 solid;">
   ...
   <tbody>
      <tr >
         <td width="98.5%" colspan="2" align="center" bgcolor="#000000" style="font-size:18px;"> <font color="#ffffff" >Admit Card</font></td>
      </tr>
      <tr style="'.$tableCellStyleData.'">
         ...
         <td   width="65%" height="100" align="right">
         <table>
         <tbody>
         <tr>
         <td style="font-size:10px;" width="100%">
            ...
            <table width="90%">
                <tr>
                    <td width="35%" align="left"><b>Candidate ID</b></td>
                    <td width="5%" align="center"><b>:</b></td>
                    <td width="67%" align="left"><b>'.$logged_in_user->user_login.'</b></td>
                </tr>
                <tr>
                    <td align="left"><b>NID or Smart Card</b></td>
                    <td align="center"><b>:</b></td>
                    <td align="left"><b>'.$logged_in_user->nid_passport_no.'</b></td>
                </tr>
                <tr>
                    <td align="left"><b>Exam Name</b></td>
                    <td align="center"><b>:</b></td>
                    <td align="left"><b>'.$exam_details->exam_title.'</b></td>
                </tr>
                <tr>
                    <td align="left"><b>Exam Id</b></td>
                    <td align="center"><b>:</b></td>
                    <td align="left"><b>'.$exam_details->id.'</b></td>
                </tr>
                <tr>
                    <td align="left"><b>Date</b></td>
                    <td align="center"><b>:</b></td>
                    <td align="left"><b>'.$dateofExam.'</b></td>
                </tr>
                <tr>
                    <td align="left"><b>Exam Center</b></td>
                    <td align="center"><b>:</b></td>
                    <td align="left"><b>'.$venues.'</b></td>
                </tr>
                <tr>
                    <td align="left"><b>Exam Location</b></td>
                    <td align="center"><b>:</b></td>
                    <td align="left"><b>'.$venuesLocation.'</b></td>
                </tr>
            </table>
      ...
      <table>
        ...
        <tr>
            <td><img height="150" src="'.$QRfilePath.'" alt="barcode"  /></td>
        </tr>
      </table>
      </td>
      <td width="23%">
   ...
   <table align="center" width="100%">
        <tr>
            <td><h3>Exam Centre Instructions</h3></td>
        </tr>
        <tr>
            <td>Please read the following instructions carefully<br></td>
        </tr>
