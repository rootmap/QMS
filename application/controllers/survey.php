...
class Survey extends MY_Controller
{
    ...
    public function survey_list($survey_id='')
    {
        ...
        $survey = $this->survey_model->get_opensurvey_for_user($survey_id);
        ...
        if ($survey) {
            ...
            //print_r_pre($survey->survey_anms); 

            $surveyanms_html="";
            if($survey->survey_anms=="yes")
            {
                $surveyanms_html .= '<div class="notice alert alert-error">';
                    $surveyanms_html .= '<h4>Survey is Anonymous</h4><p><b>Important Note :</b>  Your Login PIN & other information will not be tracked for this survey, your survey results shall remain confidential without any risks of disclosure of your identity.</p>';
                $surveyanms_html .= '</div>';
            }
            ...
            $survey_html .= '<div class="content-wrap">';
                $survey_html .= '<div id="running-survey">';
                    ...
                    $survey_html .= '<div class="survey-info">';
                        ...
                        $survey_html .=$surveyanms_html;

                        $survey_html .= '<div class="notice alert alert-info">';
                            $survey_html .= "Please ensure that you have enough time and resource available to complete the survey. <br /><br />
                ...
                $question_html .= '<div id="running-survey">';
                    ...
                    $question_html .= form_open();
                        $question_html .= '<div class="survey-header">';
                            $question_html .= '<div class="qn">'. $question_number_str .'</div><br>';
                        $question_html .= '</div>';
                        ...
                        $question_html .= '<div class="survey-body">';
                            $question_html .= '<div class="question">';
                                ...
                                $question_html .= '<div class="text">';
                                    $question_html .= html_entity_decode($survey->current_question->ques_text);
                                $question_html .= '</div>';
                            $question_html .= '</div>';
