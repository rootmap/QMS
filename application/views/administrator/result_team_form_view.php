    ...
    <div class="well">
        <div class="row-fluid result_summary" style="margin-top: 0;">
            <div class="span3" style="text-align: center;">
                <div class="big_text info"><?php echo ($attendee+$non_attendee); ?></div> Total Attendee
            </div>
            <div class="span3" style="text-align: center;">
                <div class="big_text success"><?php echo $attendee; ?></div> Present
            </div>
            <div class="span3" style="text-align: center;">
                <div class="big_text error"><?php echo $non_attendee; ?></div> Absent
            </div>
            <div class="span3" style="text-align: center;">
