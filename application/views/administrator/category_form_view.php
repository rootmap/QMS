        ...
        <ul class="nav nav-tabs">
          ...
          <div class="tab-content">
            ...
            <div id="menu1" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/category/update_category'); }else{ echo site_url('administrator/category/add_sub_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu2" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat_two'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/category/update_category'); }else{ echo site_url('administrator/category/add_sub_two_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu3" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat_three'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/category/update_category'); }else{ echo site_url('administrator/category/add_sub_three_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu4" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat_four'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/category/update_category'); }else{ echo site_url('administrator/category/add_sub_four_category'); } ?>">
                    <fieldset>
