...
$total_user_mark=0;
if(count($subject_wise)>0)
{
    foreach($subject_wise as $sub)
    {
        $total_subject_mark+=$sub->subject_marks;
        $total_user_mark+=$sub->marks;
    }
}
...
$user_score = number_format((float)$total_user_mark, 2);
    ...
    <div class="well exam-info">
        ...
        <div class="span6">
            ...
            <p class="meta">
                ...
                <span><?php echo $examCandOInfo->login_pin; ?></span>
            </p>
            <p class="meta">
                <strong>Candidate Name</strong>
                <span><?php echo $examCandOInfo->candidate_name; ?></span>
            </p>
            <p class="meta">
        ...
        if(isset($subject_wise))
        {
            ...
            <div class="span8">
                ...
                <table class="table" border="1">
                    ...
                    ?>
                            <tr>
                                <td colspan="2" align="right" style="text-align: right;"><b>Total = </b></td>
                                <td><b><?php echo $total_subject_mark; ?></b></td>
                                <td><b><?php echo $total_user_mark; ?></b></td>
                            </tr>
                    </tbody>
                </table>
        ...
        <div class="review-body" id="review-body"><div id="qa-items-cont">
            ...
            <div class="qa-item">
                ...
                <div class="question">
                    ...
                    <div class="text"><?php if(isset($questions[$i]->question->ques_text)) {echo html_entity_decode(trim($questions[$i]->question->ques_text));} ?></div>
                ...
                <div class="answers">
                    ...
                    <?php else: ?>
                            ...
                            if ($questions[$i]->question->ques_answer_type == 'correct') {
                            ?>
                            <strong>Score: <?php if(isset($questions[$i]->question->ques_score)){ echo (float)$questions[$i]->question->ques_score; }  ?> / <?php if(isset($questions[$i]->question->ques_score)){ echo (float)$questions[$i]->question->ques_score; }  ?></strong>
                            <?php 
                            }else{
                                ?>
                                <strong>Score: 0 / <?php if(isset($questions[$i]->question->ques_score)){ echo (float)$questions[$i]->question->ques_score; }  ?></strong>
                                <?php 
                            } 
                            ?>
                    <?php endif; ?>
