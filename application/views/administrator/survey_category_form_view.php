        ...
        <ul class="nav nav-tabs">
          ...
          <div class="tab-content">
            <div id="home" class="tab-pane fade <?php if(!empty($this->session->userdata('tab_cat'))){ ?> in active<?php } ?>">
                <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/survey_category/update_category'); }else{ echo site_url('administrator/survey_category/add_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu1" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/survey_category/update_category'); }else{ echo site_url('administrator/survey_category/add_sub_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu2" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat_two'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/survey_category/update_category'); }else{ echo site_url('administrator/survey_category/add_sub_two_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu3" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat_three'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/survey_category/update_category'); }else{ echo site_url('administrator/survey_category/add_sub_three_category'); } ?>">
                    <fieldset>
            ...
            <div id="menu4" class="tab-pane fade<?php if(!empty($this->session->userdata('tab_subcat_four'))){ ?> in active<?php } ?>">
              <form method="post" action="<?php if(isset($is_edit)){ echo site_url('administrator/survey_category/update_category'); }else{ echo site_url('administrator/survey_category/add_sub_four_category'); } ?>">
                    <fieldset>
...
<script type="text/javascript">
    ...
    function loadCategory()
    {
        var getCurrentID=0;
        <?php 
        if(isset($this->form_data->cat_parent))
        {
            if($this->form_data->cat_parent>0)
            {
                ?>
                getCurrentID="<?php echo $this->form_data->cat_parent; ?>";
                <?php
            }
        }
        ?>
    ...
    function loadSubCategory(cid)
    {
        var getCurrentID=0;
        <?php 
        if(isset($this->form_data->sub_cat_parent))
        {
            if($this->form_data->sub_cat_parent>0)
            {
                ?>
                getCurrentID="<?php echo $this->form_data->sub_cat_parent; ?>";
                <?php
            }
        }
        ?>
    ...
    function loadSubTwoCategory(cid,SubCat)
    {
        var getCurrentID=0;
        <?php 
        if(isset($this->form_data->sub_two_cat_parent))
        {
            if($this->form_data->sub_two_cat_parent>0)
            {
                ?>
                getCurrentID="<?php echo $this->form_data->sub_two_cat_parent; ?>";
                <?php
            }
        }
        ?>
    ...
    function loadSubThreeCategory(cid,SubCat,SubTwoCat)
    {
        var getCurrentID=0;
        <?php 
        if(isset($this->form_data->sub_three_cat_parent))
        {
            if($this->form_data->sub_three_cat_parent>0)
            {
                ?>
                getCurrentID="<?php echo $this->form_data->sub_three_cat_parent; ?>";
                <?php
            }
        }
        ?>
