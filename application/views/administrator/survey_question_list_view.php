        ...
        //------------------------Ajax Customer Start-------------------------//
         ...
         $.ajax({
            ...
            'success': function (data) {
                ...
                if(data)
                {
                    htmlString +='<option value="">Category</option>';
        ...
        //------------------------Ajax Customer Start-------------------------//
         ...
         $.ajax({
            ...
            'success': function (data) {
                ...
                if(data)
                {
                    htmlString +='<option value="">Sub Category</option>';
                    $.each(data,function(key,row){
        ...
        //------------------------Ajax Customer Start-------------------------//
         ...
         $.ajax({
            ...
            'success': function (data) {
                ...
                if(data)
                {
                    htmlString +='<option value="">Sub 2 Category</option>';
                    $.each(data,function(key,row){
                        if(row.cat_parent==cid)
                        {
        ...
        //------------------------Ajax Customer Start-------------------------//
         ...
         $.ajax({
            ...
            'success': function (data) {
                ...
                if(data)
                {
                    htmlString +='<option value="">Sub 3 Category</option>';
                    $.each(data,function(key,row){
                        if(row.cat_parent==cid)
                        {
                            if(row.sub_cat_parent==SubCat)
        ...
        //------------------------Ajax Customer Start-------------------------//
         ...
         $.ajax({
            ...
            'success': function (data) {
                ...
                if(data)
                {
                    htmlString +='<option value="">Sub 4 Category</option>';
                    $.each(data,function(key,row){
                        if(row.cat_parent==cid)
                        {
                            if(row.sub_cat_parent==SubCat)
